...
namespace Offsets
{
    ...
    // m_pClippingWeapon was removed, use m_hActiveWeapon from m_pWeaponServices instead
    ...
    constexpr std::ptrdiff_t m_pClippingWeapon = m_pWeaponServices; // Compatibility: redirect to weapon services
    ...
    // Model reload offsets from a2x/cs2-dumper (C_EconEntity)
    // Updated: 2025-05-03 - Verified from client_dll.hpp
    constexpr std::ptrdiff_t m_bAttachmentDirty = 0x1690;  // bool - Marks that attachments need reload
    constexpr std::ptrdiff_t m_nUnloadedModelIndex = 0x1694;  // int32 - Forces model reload (-1 = reload)
}